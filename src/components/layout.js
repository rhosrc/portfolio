...
import signup from '../images/bg-signup.jpeg'
import demo1 from '../images/demo-image-01.jpeg'
import demo2 from '../images/demo-image-02.jpeg'
        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src={demo1} alt="..." /></div>
                    <div class="col-lg-6">
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src={demo2} alt="..." /></div>
